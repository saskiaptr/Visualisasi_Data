...
data = {
    ...
    'Teknik Informatika': [100, 110, 120, 130, 140],
    'Sistem Informasi': [120, 130, 140, 150, 160],
    'Ilmu Komputer': [90, 95, 100, 105, 110],
...
# streamlit app
st.title("Visualisasi Tren Jumlaj Mahasiswa Memilih Jurusan Komputer (5 Tahun Terakhir)")
